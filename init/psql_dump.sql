...
INSERT INTO public.resource_type (id, prefix, name, properties, public_id_prefix, validator_mandatory, rank) VALUES (2, 'ega', 'Dataset', '{"ui_schema": {"type": "group", "elements": [{"type": "VerticalLayout", "elements": [{"type": "HorizontalLayout", "elements": [{"type": "VerticalLayout", "elements": [{"rule": {"effect": "SHOW", "condition": {"scope": "#", "schema": {"required": ["public_id"], "properties": {"public_id": {"type": "string"}}}}}, "type": "Control", "label": "FEGA Dataset ID", "scope": "#/properties/public_id", "options": {"readonly": true}}, {"type": "Control", "label": "Title", "scope": "#/properties/title"}, {"type": "Control", "label": "Description", "scope": "#/properties/description", "options": {"multi": true}}, {"type": "Control", "label": "Release Date", "scope": "#/properties/released_date", "options": {"format": "date", "dateFormat": "DD.MM.YYYY", "dateSaveFormat": "YYYY-MM-DD"}}, {"type": "HorizontalLayout", "elements": [{"type": "Control", "scope": "#/properties/extra_attributes"}]}]}, {"type": "VerticalLayout", "elements": [{"type": "Control", "label": "Dataset types", "scope": "#/properties/dataset_types"}]}]}, {"type": "HorizontalLayout", "elements": [{"type": "Control", "label": "Runs", "scope": "#/properties/run_public_ids"}, {"type": "Control", "label": "Analyses", "scope": "#/properties/analysis_public_ids"}]}]}]}, "data_schema": {"type": "object", "title": "Dataset", "x-cega": {"schema": {"foreignKeys": [{"fields": ["title"], "reference": {"fields": ["title"], "resource": "datasets"}}, {"fields": ["description"], "reference": {"fields": ["description"], "resource": "datasets"}}, {"fields": ["dataset_types"], "reference": {"fields": ["dataset_types"], "resource": "datasets"}}, {"fields": ["policy_id"], "reference": {"fields": ["policy_accession_id"], "resource": "datasets"}}, {"fields": ["run_public_ids"], "reference": {"fields": ["run_provisional_ids"], "resource": "datasets"}}, {"fields": ["analysis_public_ids"], "reference": {"fields": ["analysis_provisional_ids"], "resource": "datasets"}}, {"fields": ["extra_attributes"], "reference": {"fields": ["extra_attributes"], "resource": "datasets"}}]}}, "$schema": "http://json-schema.org/draft-07/schema#", "required": ["title", "description", "dataset_types", "run_public_ids", "released_date"], "properties": {"title": {"type": "string"}, "policy_id": {"type": ["string", "null"], "format": "uuid"}, "public_id": {"type": "string", "pattern": "^CHFEGAD[0-9]{11}"}, "description": {"type": "string"}, "dataset_types": {"type": "array", "items": {"enum": ["Whole genome sequencing", "Exome sequencing", "Genotyping by array", "Transcriptome profiling by high-throughput sequencing", "Transcriptome profiling by array", "Amplicon sequencing", "Methylation binding domain sequencing", "Methylation profiling by high-throughput sequencing", "Phenotype information", "Study summary information", "Genomic variant calling", "Chromatin accessibility profiling by high-throughput sequencing", "Histone modification profiling by high-throughput sequencing", "Chip-Seq"], "type": "string"}, "x-check": "verticalcheckbox", "uniqueItems": true}, "released_date": {"type": "string", "format": "date"}, "run_public_ids": {"type": "array", "items": {"type": "string", "pattern": "^CHFEGAR[0-9]{11}"}, "x-check": "MolecularRun", "uniqueItems": true, "x-check_title": "title", "x-check_value": "public_id"}, "extra_attributes": {"type": "array", "items": {"type": "object", "required": ["tag", "value", "unit"], "properties": {"tag": {"type": "string"}, "unit": {"type": "string"}, "value": {"type": ["string", "integer", "number"]}}}}, "policy_public_id": {"type": ["string", "null"], "pattern": "^CHFEGAP[0-9]{11}", "x-check": "Policy", "description": "Data Access Policy Public ID", "x-check_title": "title", "x-check_value": "public_id"}, "analysis_public_ids": {"type": "array", "items": {"type": "string", "pattern": "^CHFEGAZ[0-9]{11}"}, "x-check": "MolecularAnalysis", "uniqueItems": true, "x-check_title": "title", "x-check_value": "public_id"}}, "x-resource": {"schema": {"fields": [{"name": "title", "constraints": {"required": true}}, {"name": "description", "constraints": {"required": true}}, {"name": "dataset_types", "type": "list", "constraints": {"required": true}}, {"name": "runs", "type": "list"}, {"name": "analyses", "type": "list"}, {"name": "released_date", "constraints": {"required": true}}], "primaryKey": ["title"], "foreignKeys": [{"fields": ["runs"], "reference": {"fields": ["title"], "resource": "MolecularRun"}}, {"fields": ["analyses"], "reference": {"fields": ["title"], "resource": "MolecularAnalysis"}}]}}}}', 'CHFEGAD', true, 8) ON CONFLICT DO NOTHING;
...
INSERT INTO public.resource_type (id, prefix, name, properties, public_id_prefix, validator_mandatory, rank) VALUES (19, 'ega', 'ImageExperiment', '{"ui_schema": {"type": "group", "elements": [{"type": "VerticalLayout", "elements": [{"type": "HorizontalLayout", "elements": [{"rule": {"effect": "SHOW", "condition": {"scope": "#", "schema": {"required": ["public_id"], "properties": {"public_id": {"type": "string"}}}}}, "type": "Control", "label": "FEGA Experiment ID", "scope": "#/properties/public_id", "options": {"readonly": true}}, {"type": "Control", "scope": "#/properties/title"}]}, {"type": "HorizontalLayout", "elements": [{"type": "Control", "scope": "#/properties/preparation_method", "options": {"multi": true}}]}, {"type": "HorizontalLayout", "elements": [{"type": "Control", "scope": "#/properties/signal_contrast_mechanism"}]}, {"type": "HorizontalLayout", "elements": [{"type": "Control", "scope": "#/properties/instrument_attributes"}]}, {"type": "HorizontalLayout", "elements": [{"type": "Control", "scope": "#/properties/image_acquisition_parameters"}]}, {"type": "Control", "scope": "#/properties/channels"}, {"type": "Control", "scope": "#/properties/extra_attributes"}]}]}, "data_schema": {"type": "object", "title": "ImageExperiment", "$schema": "http://json-schema.org/draft-07/schema#", "required": ["title", "preparation_method"], "properties": {"title": {"type": "string", "title": "title", "description": "The experiment alias"}, "channels": {"type": "array", "items": {"type": "object", "properties": {"channel_content": {"type": "string", "title": "Channel-content", "description": "Specific specimen staining"}, "channel_biological_entity": {"type": "string", "title": "Channel - biological entity", "description": "What molecule is stained"}}}}, "public_id": {"type": "string", "title": "Public ID", "pattern": "^CHFEGAX[0-9]{11}.*", "description": "Public Identifier of the experiment"}, "extra_attributes": {"type": "array", "items": {"type": "object", "required": ["tag", "value"], "properties": {"tag": {"type": "string"}, "unit": {"type": "string"}, "value": {"type": ["string", "integer", "number"]}}}, "title": "Extra Attributes", "description": "Any extra attribute(s) to describe an experiment"}, "preparation_method": {"type": "string", "title": "Preparation method", "description": "Sample preparation protocol"}, "instrument_attributes": {"type": "string", "title": "Instrument attributes", "description": "Details about instruments used"}, "signal_contrast_mechanism": {"type": "string", "title": "Signal/contrast mechanism", "description": "How is the signal generated by this sample"}, "image_acquisition_parameters": {"type": "string", "title": "Image acquisition parameters", "description": "Image acquisition details"}}, "x-resource": {"schema": {"fields": [{"name": "title", "constraints": {"required": true}}, {"name": "preparation_method", "constraints": {"required": true}}], "primaryKey": ["title"]}}}}', 'CHFEGAX', true, 3) ON CONFLICT DO NOTHING;
INSERT INTO public.resource_type (id, prefix, name, properties, public_id_prefix, validator_mandatory, rank) VALUES (20, 'ega', 'ImageRun', '{"ui_schema": {"type": "group", "elements": [{"type": "VerticalLayout", "elements": [{"type": "HorizontalLayout", "elements": [{"rule": {"effect": "SHOW", "condition": {"scope": "#", "schema": {"required": ["public_id"], "properties": {"public_id": {"type": "string"}}}}}, "type": "Control", "label": "FEGA Image Run ID", "scope": "#/properties/public_id", "options": {"readonly": true}}, {"type": "Control", "label": "Title", "scope": "#/properties/title"}, {"type": "Control", "label": "Experiment", "scope": "#/properties/imageexperiment_public_id"}]}, {"type": "HorizontalLayout", "elements": [{"type": "Control", "label": "Sample", "scope": "#/properties/sample_public_id"}, {"type": "Control", "scope": "#/properties/sdafile_public_ids"}]}, {"type": "HorizontalLayout", "elements": [{"type": "Control", "label": "Type", "scope": "#/properties/type"}, {"type": "Control", "scope": "#/properties/format_and_compression"}]}, {"type": "HorizontalLayout", "elements": [{"type": "Control", "scope": "#/properties/image_processing_method", "options": {"multi": true}}, {"type": "Control", "scope": "#/properties/contrast_inversion_to_tem"}]}, {"type": "HorizontalLayout", "elements": [{"type": "Control", "scope": "#/properties/qc_info"}]}, {"type": "Group", "label": "Dimension extents", "elements": [{"type": "HorizontalLayout", "elements": [{"type": "Control", "scope": "#/properties/dimension_extents/properties/x"}, {"type": "Control", "scope": "#/properties/dimension_extents/properties/y"}, {"type": "Control", "scope": "#/properties/dimension_extents/properties/z"}, {"type": "Control", "scope": "#/properties/dimension_extents/properties/tilts"}]}]}, {"type": "Group", "label": "Size description", "elements": [{"type": "HorizontalLayout", "elements": [{"type": "Group", "label": "X", "elements": [{"type": "HorizontalLayout", "elements": [{"type": "Control", "label": "value", "scope": "#/properties/size_description/properties/x/properties/value"}, {"type": "Control", "label": "unit", "scope": "#/properties/size_description/properties/x/properties/unit"}]}]}, {"type": "Group", "label": "Y", "elements": [{"type": "HorizontalLayout", "elements": [{"type": "Control", "label": "value", "scope": "#/properties/size_description/properties/y/properties/value"}, {"type": "Control", "label": "unit", "scope": "#/properties/size_description/properties/y/properties/unit"}]}]}, {"type": "Group", "label": "Z", "elements": [{"type": "HorizontalLayout", "elements": [{"type": "Control", "label": "value", "scope": "#/properties/size_description/properties/z/properties/value"}, {"type": "Control", "label": "unit", "scope": "#/properties/size_description/properties/z/properties/unit"}]}]}]}]}, {"type": "Group", "label": "Pixel/voxel size description", "elements": [{"type": "HorizontalLayout", "elements": [{"type": "Group", "label": "X", "elements": [{"type": "HorizontalLayout", "elements": [{"type": "Control", "label": "value", "scope": "#/properties/pixel_voxel_size_description/properties/x/properties/value"}, {"type": "Control", "label": "unit", "scope": "#/properties/pixel_voxel_size_description/properties/x/properties/unit"}]}]}, {"type": "Group", "label": "Y", "elements": [{"type": "HorizontalLayout", "elements": [{"type": "Control", "label": "value", "scope": "#/properties/pixel_voxel_size_description/properties/y/properties/value"}, {"type": "Control", "label": "unit", "scope": "#/properties/pixel_voxel_size_description/properties/y/properties/unit"}]}]}, {"type": "Group", "label": "Z", "elements": [{"type": "HorizontalLayout", "elements": [{"type": "Control", "label": "value", "scope": "#/properties/pixel_voxel_size_description/properties/z/properties/value"}, {"type": "Control", "label": "unit", "scope": "#/properties/pixel_voxel_size_description/properties/z/properties/unit"}]}]}]}]}, {"type": "HorizontalLayout", "elements": [{"type": "Control", "scope": "#/properties/extra_attributes"}]}]}]}, "data_schema": {"type": "object", "title": "ImageRun", "$schema": "http://json-schema.org/draft-07/schema#", "required": ["title", "sdafile_public_ids", "imageexperiment_public_id", "sample_public_id", "type", "format_and_compression", "dimension_extents"], "properties": {"type": {"type": "string", "title": "type", "description": "Primary image/processed image/segmentation"}, "title": {"type": "string", "title": "title", "description": "Title of the Run"}, "qc_info": {"type": "string", "title": "QC info", "description": "QC score for uploaded image quality if applicable"}, "public_id": {"type": "string", "title": "Public ID", "pattern": "^CHFEGAR[0-9]{11}.*", "description": "public ID of the Run"}, "extra_attributes": {"type": "array", "items": {"type": "object", "required": ["tag", "value"], "properties": {"tag": {"type": "string"}, "unit": {"type": "string"}, "value": {"type": ["string", "integer", "number"]}}}, "description": "Any extra attributes that describe the Run"}, "sample_public_id": {"type": "string", "title": "Sample", "pattern": "^CHFEGAN[0-9]{11}.*", "x-check": "Sample", "description": "Public ID of associated sample", "x-check_title": "title", "x-check_value": "public_id"}, "size_description": {"type": "object", "title": "Size description", "properties": {"x": {"type": "object", "title": "X", "properties": {"unit": {"enum": ["nm", "µm", "mm", "cm", "m"], "type": "string", "title": "unit"}, "value": {"type": "number", "title": "value"}}}, "y": {"type": "object", "title": "Y", "properties": {"unit": {"enum": ["nm", "µm", "mm", "cm", "m"], "type": "string", "title": "unit"}, "value": {"type": "number", "title": "value"}}}, "z": {"type": "object", "title": "Z", "properties": {"unit": {"enum": ["nm", "µm", "mm", "cm", "m"], "type": "string", "title": "unit"}, "value": {"type": "number", "title": "value"}}}, "magnification": {"type": "string", "title": "magnification"}}, "description": "Physical size of image volume in x,y,z & units or magnification"}, "dimension_extents": {"type": "object", "title": "Dimension extents", "properties": {"x": {"type": "integer", "title": "X"}, "y": {"type": "integer", "title": "Y"}, "z": {"type": "integer", "title": "Z"}, "tilts": {"type": "integer", "title": "tilts"}}, "description": "Volume in pixels: x, y, z, tilts"}, "sdafile_public_ids": {"type": "array", "items": {"type": "string", "pattern": "^CHFEGAF[0-9]{11}.*", "x-check": "SdaFile", "x-check_title": "title", "x-check_value": "public_id"}, "title": "File", "description": "List of associated file public ids", "uniqueItems": true}, "experimental_status": {"type": "string", "title": "Experimental status", "description": "Test/control"}, "format_and_compression": {"type": "string", "title": "Format & compression", "description": "Image format and compression type"}, "image_processing_method": {"type": "string", "title": "Image processing method", "description": "Processing methods applied to this dataset"}, "contrast_inversion_to_tem": {"enum": ["Yes", "No", "N/A"], "type": "string", "title": "Contrast inversion to TEM", "description": "Y/N; N if stained features result in brighter signal; Y if it looks like a TEM image"}, "imageexperiment_public_id": {"type": "string", "title": "Experiment", "pattern": "^CHFEGAX[0-9]{11}.*", "x-check": "MolecularExperiment", "description": "Public ID of associated image experiment", "x-check_title": "properties.title", "x-check_value": "public_id"}, "pixel_voxel_size_description": {"type": "object", "title": "Pixel/voxel size description", "properties": {"x": {"type": "object", "title": "X", "properties": {"unit": {"enum": ["nm", "µm", "mm", "cm", "m"], "type": "string", "title": "unit"}, "value": {"type": "number", "title": "value"}}}, "y": {"type": "object", "title": "Y", "properties": {"unit": {"enum": ["nm", "µm", "mm", "cm", "m"], "type": "string", "title": "unit"}, "value": {"type": "number", "title": "value"}}}, "z": {"type": "object", "title": "Z", "properties": {"unit": {"enum": ["nm", "µm", "mm", "cm", "m"], "type": "string", "title": "unit"}, "value": {"type": "number", "title": "value"}}}, "magnification": {"type": "string", "title": "magnification"}}, "description": "Physical size of pixels/voxels in x, y, z & units"}}, "x-resource": {"schema": {"fields": [{"name": "title", "constraints": {"required": true}}, {"name": "experiment"}, {"name": "sample"}, {"name": "files", "type": "list", "aliasOf": "sdafile_public_ids", "constraints": {"required": true, "jsonSchema": {"type": "array", "items": {"type": "string"}, "uniqueItems": true}}}, {"name": "file_type", "aliasOf": "run_file_type", "constraints": {"required": true}}], "primaryKey": ["title"], "foreignKeys": [{"fields": ["experiment"], "reference": {"fields": ["title"], "resource": "MolecularExperiment"}}, {"fields": ["sample"], "reference": {"fields": ["title"], "resource": "Sample"}}]}}}}', 'CHFEGAR', true, 4) ON CONFLICT DO NOTHING;
INSERT INTO public.resource_type (id, prefix, name, properties, public_id_prefix, validator_mandatory, rank) VALUES (22, 'ega', 'ImageDataset', '{"ui_schema": {"type": "group", "elements": [{"type": "VerticalLayout", "elements": [{"type": "HorizontalLayout", "elements": [{"type": "VerticalLayout", "elements": [{"rule": {"effect": "SHOW", "condition": {"scope": "#", "schema": {"required": ["public_id"], "properties": {"public_id": {"type": "string"}}}}}, "type": "Control", "label": "FEGA Dataset ID", "scope": "#/properties/public_id", "options": {"readonly": true}}, {"type": "Control", "label": "Title", "scope": "#/properties/title"}, {"type": "Control", "label": "Description", "scope": "#/properties/description", "options": {"multi": true}}, {"type": "Control", "label": "Released Date", "scope": "#/properties/released_date", "options": {"format": "date", "dateFormat": "DD.MM.YYYY", "dateSaveFormat": "YYYY-MM-DD"}}, {"type": "HorizontalLayout", "elements": [{"type": "Control", "scope": "#/properties/extra_attributes"}]}]}, {"type": "VerticalLayout", "elements": [{"type": "Control", "label": "Dataset types", "scope": "#/properties/dataset_types"}]}]}, {"type": "HorizontalLayout", "elements": [{"type": "Control", "label": "Runs", "scope": "#/properties/run_public_ids"}, {"type": "Control", "label": "Analyses", "scope": "#/properties/analysis_public_ids"}]}]}]}, "data_schema": {"type": "object", "title": "Dataset", "x-cega": {"schema": {"foreignKeys": [{"fields": ["title"], "reference": {"fields": ["title"], "resource": "datasets"}}, {"fields": ["description"], "reference": {"fields": ["description"], "resource": "datasets"}}, {"fields": ["dataset_types"], "reference": {"fields": ["dataset_types"], "resource": "datasets"}}, {"fields": ["policy_id"], "reference": {"fields": ["policy_accession_id"], "resource": "datasets"}}, {"fields": ["run_public_ids"], "reference": {"fields": ["run_provisional_ids"], "resource": "datasets"}}, {"fields": ["analysis_public_ids"], "reference": {"fields": ["analysis_provisional_ids"], "resource": "datasets"}}, {"fields": ["extra_attributes"], "reference": {"fields": ["extra_attributes"], "resource": "datasets"}}]}}, "$schema": "http://json-schema.org/draft-07/schema#", "required": ["title", "description", "dataset_types", "run_public_ids", "released_date"], "properties": {"title": {"type": "string"}, "policy_id": {"type": ["string", "null"], "format": "uuid"}, "public_id": {"type": "string", "pattern": "^CHFEGAD[0-9]{11}"}, "description": {"type": "string"}, "dataset_types": {"type": "array", "items": {"enum": ["Digital pathology", "Expansion microscopy", "Localisation markers", "Force microscopy", "Histology", "Interferometric microscopy", "Intravital imaging", "Light field microscopy", "Mass spectrometry imaging", "Environmental transmission electron microscopy", "Point detection microscopy", "Sample material separation", "Diffractometry and scattering", "Label-free imaging"], "type": "string"}, "x-check": "verticalcheckbox", "uniqueItems": true}, "released_date": {"type": "string", "format": "date"}, "run_public_ids": {"type": "array", "items": {"type": "string", "pattern": "^CHFEGAR[0-9]{11}"}, "x-check": "ImageRuns", "uniqueItems": true}, "extra_attributes": {"type": "array", "items": {"type": "object", "required": ["tag", "value", "unit"], "properties": {"tag": {"type": "string"}, "unit": {"type": "string"}, "value": {"type": ["string", "integer", "number"]}}}}, "policy_public_id": {"type": ["string", "null"], "pattern": "^CHFEGAP[0-9]{11}", "x-check": "Policy", "description": "Data Access Policy Public ID", "x-check_title": "title", "x-check_value": "public_id"}, "analysis_public_ids": {"type": "array", "items": {"type": "string", "pattern": "^CHFEGAZ[0-9]{11}"}, "x-check": "ImageAnalysis", "uniqueItems": true, "x-check_title": "title", "x-check_value": "public_id"}}, "x-resource": {"schema": {"fields": [{"name": "title", "constraints": {"required": true}}, {"name": "description", "constraints": {"required": true}}, {"name": "dataset_types", "type": "list", "constraints": {"required": true}}, {"name": "runs", "type": "list"}, {"name": "analyses", "type": "list"}], "primaryKey": ["title"], "foreignKeys": [{"type": "list", "fields": ["runs"], "reference": {"fields": ["title"], "resource": "ImageRun"}}, {"fields": ["analyses"], "reference": {"fields": ["title"], "resource": "ImageAnalysis"}}]}}}}', 'CHFEGAD', true, 8) ON CONFLICT DO NOTHING;
...
INSERT INTO public.resource_type (id, prefix, name, properties, public_id_prefix, validator_mandatory, rank) VALUES (21, 'ega', 'ImageAnalysis', '{"ui_schema": {"type": "group", "elements": [{"type": "VerticalLayout", "elements": [{"type": "HorizontalLayout", "elements": [{"type": "VerticalLayout", "elements": [{"type": "Control", "label": "Files", "scope": "#/properties/sdafile_public_ids"}, {"type": "Control", "label": "Experiments", "scope": "#/properties/imageexperiment_public_ids"}]}, {"type": "VerticalLayout", "elements": [{"type": "Control", "label": "Samples", "scope": "#/properties/sample_public_ids"}]}]}, {"type": "HorizontalLayout", "elements": [{"type": "VerticalLayout", "elements": [{"type": "Control", "scope": "#/properties/title"}]}, {"type": "VerticalLayout", "elements": [{"type": "Control", "label": "Analysis result type", "scope": "#/properties/analysis_result_type"}]}]}, {"type": "VerticalLayout", "elements": [{"type": "Control", "label": "Analysis method and details", "scope": "#/properties/analysis_method_and_details", "options": {"multi": true}}, {"type": "Control", "scope": "#/properties/extra_attributes"}]}]}], "displayedElements": ["properties.title", "properties.analysis_type", "properties.platform", "properties.experiment_types"]}, "data_schema": {"type": "object", "title": "Image Analysis", "$schema": "http://json-schema.org/draft-07/schema#", "required": ["title", "analysis_result_type", "sdafile_public_ids", "analysis_method_and_details", "imageexperiment_public_ids", "sample_public_ids"], "properties": {"title": {"type": "string", "description": "Title of the analysis"}, "public_id": {"type": "string", "pattern": "^CHFEGAZ[0-9]{11}", "description": "Public ID of the analysis"}, "extra_attributes": {"type": "array", "items": {"type": "object", "required": ["tag", "value", "unit"], "properties": {"tag": {"type": "string"}, "unit": {"type": "string"}, "value": {"type": ["string", "integer", "number"]}}}, "description": "Any extra attributes associated with the analysis"}, "sample_public_ids": {"type": "array", "items": {"type": "string", "pattern": "^CHFEGAN[0-9]{11}.*", "x-check": "Sample", "x-check_title": "title", "x-check_value": "public_id"}, "description": "List of associated sample public ids", "uniqueItems": true}, "sdafile_public_ids": {"type": "array", "items": {"type": "string", "pattern": "^CHFEGAF[0-9]{11}.*", "x-check": "SdaFile", "x-check_title": "title", "x-check_value": "public_id"}, "description": "List of associated file public ids", "uniqueItems": true}, "analysis_result_type": {"type": "string", "description": "Numerical analyses, segmention (non-image), categorical features/phenotypes"}, "imageexperiment_public_ids": {"type": "array", "items": {"type": "string", "pattern": "^CHFEGAX[0-9]{11}.*", "x-check": "ImageExperiment", "x-check_title": "properties.design_description", "x-check_value": "public_id"}, "description": "List of associated experiment public ids", "uniqueItems": true}, "analysis_method_and_details": {"type": "string", "description": "Analysis method"}}, "x-resource": {"schema": {"fields": [{"name": "files", "type": "list", "aliasOf": "sdafile_public_ids", "constraints": {"required": true, "jsonSchema": {"type": "array", "items": {"type": "string"}, "uniqueItems": true}}}, {"name": "title", "constraints": {"required": true}}, {"name": "analysis_method_and_details", "constraints": {"required": true}}, {"name": "description", "constraints": {"required": true}}, {"name": "analysis_result_type", "constraints": {"required": true}}, {"name": "samples", "type": "list"}, {"name": "experiments", "type": "list"}], "primaryKey": ["title"], "foreignKeys": [{"fields": ["samples"], "reference": {"fields": ["title"], "resource": "Sample"}}, {"fields": ["experiments"], "reference": {"fields": ["title"], "resource": "ImageExperiment"}}]}}}}', 'CHFEGAZ', true, 5) ON CONFLICT DO NOTHING;
