...
INSERT INTO "public"."resource_type" ("id", "prefix", "name", "properties", "public_id_prefix", "validator_mandatory", "rank") VALUES (2, 'ega', 'Dataset', '{"ui_schema": {"type": "group", "elements": [{"type": "VerticalLayout", "elements": [{"type": "HorizontalLayout", "elements": [{"type": "VerticalLayout", "elements": [{"rule": {"effect": "SHOW", "condition": {"scope": "#", "schema": {"required": ["public_id"], "properties": {"public_id": {"type": "string"}}}}}, "type": "Control", "label": "FEGA Dataset ID", "scope": "#/properties/public_id", "options": {"readonly": true}}, {"type": "Control", "label": "Title", "scope": "#/properties/title"}, {"type": "Control", "label": "Description", "scope": "#/properties/description", "options": {"multi": true}}, {"type": "Control", "label": "Release Date", "scope": "#/properties/released_date", "options": {"format": "date", "dateFormat": "DD.MM.YYYY", "dateSaveFormat": "YYYY-MM-DD"}}]}, {"type": "VerticalLayout", "elements": [{"type": "Control", "label": "Dataset Types", "scope": "#/properties/dataset_types"}]}]}, {"type": "HorizontalLayout", "elements": [{"type": "Control", "scope": "#/properties/extra_attributes"}]}, {"type": "HorizontalLayout", "elements": [{"type": "Control", "label": "Molecular Run", "scope": "#/properties/molecularrun_public_ids"}, {"type": "Control", "label": "Molecular Analysis", "scope": "#/properties/molecularanalysis_public_ids"}]}]}]}, "data_schema": {"type": "object", "title": "Dataset", "x-cega": {"schema": {"foreignKeys": [{"fields": ["title"], "reference": {"fields": ["title"], "resource": "datasets"}}, {"fields": ["description"], "reference": {"fields": ["description"], "resource": "datasets"}}, {"fields": ["dataset_types"], "reference": {"fields": ["dataset_types"], "resource": "datasets"}}, {"fields": ["policy_id"], "reference": {"fields": ["policy_accession_id"], "resource": "datasets"}}, {"fields": ["molecularrun_public_ids"], "reference": {"fields": ["run_provisional_ids"], "resource": "datasets"}}, {"fields": ["molecularanalysis_public_ids"], "reference": {"fields": ["analysis_provisional_ids"], "resource": "datasets"}}, {"fields": ["extra_attributes"], "reference": {"fields": ["extra_attributes"], "resource": "datasets"}}]}}, "$schema": "http://json-schema.org/draft-07/schema#", "required": ["title", "description", "dataset_types", "molecularrun_public_ids", "released_date"], "properties": {"title": {"type": "string"}, "policy_id": {"type": ["string", "null"], "format": "uuid"}, "public_id": {"type": "string", "pattern": "^CHFEGAD[0-9]{11}"}, "description": {"type": "string"}, "dataset_types": {"type": "array", "items": {"enum": ["Whole genome sequencing", "Exome sequencing", "Genotyping by array", "Transcriptome profiling by high-throughput sequencing", "Transcriptome profiling by array", "Amplicon sequencing", "Methylation binding domain sequencing", "Methylation profiling by high-throughput sequencing", "Phenotype information", "Study summary information", "Genomic variant calling", "Chromatin accessibility profiling by high-throughput sequencing", "Histone modification profiling by high-throughput sequencing", "Chip-Seq"], "type": "string"}}, "released_date": {"type": "string", "format": "date"}, "extra_attributes": {"type": "array", "items": {"type": "object", "required": ["tag", "value", "unit"], "properties": {"tag": {"type": "string"}, "unit": {"type": "string"}, "value": {"type": ["string", "integer", "number"]}}}}, "policy_public_id": {"type": ["string", "null"], "pattern": "^CHFEGAP[0-9]{11}", "x-check": "Policy", "description": "Data Access Policy Public ID", "x-check_title": "title", "x-check_value": "public_id"}, "molecularrun_public_ids": {"type": "array", "items": {"type": "string", "pattern": "^CHFEGAR[0-9]{11}"}, "x-check": "MolecularRun", "x-compact": true, "uniqueItems": true, "x-check_title": "title", "x-check_value": "public_id"}, "molecularanalysis_public_ids": {"type": "array", "items": {"type": "string", "pattern": "^CHFEGAZ[0-9]{11}"}, "x-check": "MolecularAnalysis", "x-compact": true, "uniqueItems": true, "x-check_title": "title", "x-check_value": "public_id"}}, "x-resource": {"schema": {"fields": [{"name": "title", "constraints": {"required": true}}, {"name": "description", "constraints": {"required": true}}, {"name": "dataset_types", "type": "list", "constraints": {"required": true}}, {"name": "runs", "type": "list"}, {"name": "analyses", "type": "list"}, {"name": "released_date", "constraints": {"required": true}}], "primaryKey": ["title"], "foreignKeys": [{"fields": ["runs"], "reference": {"fields": ["title"], "resource": "MolecularRun"}}, {"fields": ["analyses"], "reference": {"fields": ["title"], "resource": "MolecularAnalysis"}}]}}}}', 'CHFEGAD', 't', 8) ON CONFLICT DO NOTHING;
